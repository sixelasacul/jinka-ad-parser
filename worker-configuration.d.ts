/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 57d021fad4445e829ce1a0c3f17a7086)
// Runtime types generated with workerd@1.20250508.0 2025-05-21 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OPEN_API_KEY: string;
		GEOCODING_KEY: string;
		NEARBY_SEARCH_KEY: string;
		JINKA_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPEN_API_KEY" | "GEOCODING_KEY" | "NEARBY_SEARCH_KEY" | "JINKA_TOKEN">> {}
}
